-- Fix business_settings security vulnerabilities (final version)
...
-- Step 6: Add index for better performance on user_id lookups (without CONCURRENTLY)
CREATE INDEX IF NOT EXISTS idx_business_settings_user_id 
