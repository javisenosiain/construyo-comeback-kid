...
-- 5. Add triggers for audit logging on sensitive tables
CREATE TRIGGER audit_business_settings_trigger
  BEFORE INSERT OR UPDATE OR DELETE ON public.business_settings
  FOR EACH ROW EXECUTE FUNCTION public.audit_business_settings_access();
